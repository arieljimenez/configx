...
mkdir ~/LoL32 && \
    cd ~/LoL32 && \
    wget https://riotgamespatcher-a.akamaihd.net/releases/live/installer/deploy/League%20of%20Legends%20installer%20LA1.exe && \
    mv League\ of\ Legends\ installer\ LA1.exe Lol.exe && \
...
cd ~ && \
    mkdir LoL_Installer && \
    WINEPREFIX=~/LoL32 wine ~/LoL32/Lol.exe /extract:Z:/home/$USER/LoL_Installer && \
